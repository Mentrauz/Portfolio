...
export default function Education() {
  ...
  return (
    <section id="education" className="relative py-12 px-3 sm:px-4">
        ...
        <Card className="overflow-hidden bg-card/80 backdrop-blur-sm border-border/50 shadow-md hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 hover:border-primary/20 w-full rounded-xl">
          <CardHeader className="pb-4 px-4 sm:px-6">
            <div className="flex items-start gap-2">
              ...
              <CardTitle className="text-lg sm:text-xl">B.Tech in Computer Science and Engineering</CardTitle>
            </div>
            <div className="mt-3 flex flex-col gap-1 text-sm text-muted-foreground sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-3">
          ...
          <CardContent className="bg-card/50 px-4 pt-6 pb-8 sm:px-6">
