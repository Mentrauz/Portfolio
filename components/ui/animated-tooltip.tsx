      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="pointer-events-none absolute z-[9999] max-w-[calc(100vw-2rem)] overflow-hidden rounded-md shadow-sm shadow-black/5 dark:shadow-white/10"
            style={{
              top: position.y,
              left: position.x,
          ...
          >
            <div
              ref={contentRef}
              className="text-sm text-neutral-600 p-4 dark:text-neutral-400 leading-relaxed [&>*]:max-w-full [&_img]:h-auto [&_img]:max-w-full [&_img]:bg-transparent [&_img]:block [&_img]:relative [&_img]:z-10 [&_img]:mb-0 [&_span]:!opacity-100 [&_span>img]:!opacity-100 [&>p]:mb-2 [&>p]:last:mb-0 [&>p]:leading-relaxed [&>*+*]:mt-2"
            >
              {content}
            </div>
          </motion.div>
